...
## Запуск
При первом запуске программа в своей директории создаст файлы start.txt, config.txt, log.txt, а также папку params с файлами params_in.txt и params_out.txt.
...
## config.txt
Содержит в себе начальные переменные программы. Пока в файле находятся 2 параметра: delay=100, print_update_info=1. delay отвечает за задержку между тиками программы в миллисекундах.
