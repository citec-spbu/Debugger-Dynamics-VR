...
Вызывается 1 раз при запуске программы для получения значений переменных. Если config.txt  не существует, то ставит delay=100, создает и заполняет файл следующими значениями:
delay=100
